...
import 'package:tesrolla/constants.dart';
import 'package:tesrolla/home_controller.dart';
import '../models/tyrePsi.dart';
import 'components/battery_status.dart';
import 'components/door_lock.dart';
import 'components/temp_button.dart';
import 'components/temp_details.dart';
import 'components/tesrolla_bottom_navbar.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  late Animation<double> _tempDetailAnimation;
  ...
  void setupTempAnimation() {
    ...
    _tempDetailAnimation = CurvedAnimation(
      parent: _tempAnimationController,
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (context, _) {
          return Scaffold(
            bottomNavigationBar: TesrollaBottomNavBar(
              onTap: (index) {
                if (index == 1)
              ...
              child: LayoutBuilder(builder: (context, constrains) {
                return Stack(
                  ...
                  children: [
                    ...
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateRightDoorState,
                        ),
                      ),
                    ),
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateLeftDoorState,
                        ),
                      ),
                    ),
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateBonnetState,
                        ),
                      ),
                    ),
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateTrunkState,
                        ),
                      ),
                    ),
                    //Battery
                    ...
                    //Temperature
                    Positioned(
                      top: 60 * (1 - _tempDetailAnimation.value),
                      width: constrains.maxWidth,
                      height: constrains.maxHeight,
                      child: Opacity(
                        opacity: _tempDetailAnimation.value,
